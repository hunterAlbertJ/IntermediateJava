...
public class CatalogTest {
  ...
  @Test
  public void sortCatalogByVolume() {
  ...
  @Test
  public void findLoudestViaCollectionsDotMax(){
    Television loudest = Collections.max(Catalog.getInventory(),
            new Comparator<Television>() {
              @Override
