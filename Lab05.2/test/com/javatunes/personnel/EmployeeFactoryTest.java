...
public class EmployeeFactoryTest {
     ...
     */
    @Test
    public void createEmployee_shouldReturnValidSalariedEmp_seTypePassed () {
        // TODO
        Employee emp = EmployeeFactory.createEmployee(seMap);
        //check its exact type
        assertEquals(SalariedEmployee.class, emp.getClass());
        //verify that all the properties have been set
        //TODO refactor this, redundant across multiple test methods
        verifyCommonProperties(emp);
        //downcast the reference to more specific type SalariedEmployee so we can call getSalary
     ...
     */
    @Test
    public void createEmployee_shouldReturnValidSalariedEmp_heTypePassed() {
        Employee emp = EmployeeFactory.createEmployee(heMap);
        //check its exact type
        assertEquals(HourlyEmployee.class, emp.getClass());
        //verify that all the properties have been set
        verifyCommonProperties(emp);
        //downcast emo to specific type HourlyEmployee so we can call getRate, getHours
    ...
    public void createEmployee_shouldThrowIllegalArgumentException_whenInvalidTypePassed() {
        // TODO
      Map<String, String> inputMap = Map.of("type", "INVALID-TYPE");
      EmployeeFactory.createEmployee(inputMap);
    }
}